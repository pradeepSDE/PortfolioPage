...
const Nav = () => {
  const [isNavOpen, setIsNavOpen] = useState(false); // initiate isNavOpen state 
  return (
      ...
      <div className=" px-4  mr-4 flex  ">
        ...
        <div>
          <h1 className="text-lg hover:border-b-2 uppercase hover:border-b-blue-300 hover:text-blue-500  font-semibold hidden lg:block p-2 m-1">
            <a
              className="scroll-smooth transition duration-500"
              href="/#contact"
            >
              Contact
            </a>
          ...
          <nav>
            <section className="MOBILE-MENU flex lg:hidden">
              ...
              <div className={isNavOpen ? "showMenuNav " : "hideMenuNav"}>
                ...
                <ul className="MENU-LINK-MOBILE-OPEN font-poppins flex gap-4 flex-col items-center justify-between min-h-[250px]">
                  <li className="border-b hover:text-blue-500 m-8 border-gray-400 text-xl my-4 uppercase">
                  ...
                  <li className="border-b  border-gray-400 m-8 text-xl my-4 uppercase">
