...
const About = () => {
  return (
    <div id="about" className=" p-4   overflow-auto  mb-10 bg-slate-50  text-center ">
      ...
      <div className="sm:flex   m-4 mt-10">
        <div className="w-1/2 h-96 rounded-xl grayscale hover:grayscale-0 transition duration-500 sm:ml-10 border-4 w-full h-full border-blue-500 shadow-lg shadow-blue-400 ">
          <img className="rounded-xl" src="/portr.jpg" alt="" />
        </div>
